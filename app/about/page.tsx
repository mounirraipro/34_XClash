...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About X-Clash',
        url: 'https://x-clash.online/about',
        description: 'Learn about X-Clash, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'X-Clash',
...
export const metadata: Metadata = {
    title: 'About Us – X-Clash',
    description: 'Learn about X-Clash, our mission, and the team behind the game.',
    keywords: ['about X-Clash', 'game team', 'who made X-Clash'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About X-Clash</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    X-Clash was born from a simple idea: what if playing X-Clash could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched X-Clash with a clear vision — to create a free, accessible, and
                ...
                <p>
                    Every level in X-Clash is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    X-Clash offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make X-Clash better for
                    everyone.
                </p>
            </div>
        </>
