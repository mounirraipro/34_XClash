...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the X-Clash disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['X-Clash disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by X-Clash (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on x-clash.online
                ...
                <p>
                    X-Clash is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    The Site may contain articles about cognitive or educational benefits of games, and similar topics.
                    This content is for informational and entertainment purposes only and should not be construed as
                    professional medical, educational, or psychological advice. Always consult with qualified
                    professionals for health, educational, or developmental concerns.
                </p>
                ...
                <p>
                    X-Clash displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by X-Clash.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, X-Clash is not responsible for any errors
