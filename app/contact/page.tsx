...
const SUPPORT_EMAIL = 'hello@x-clash.online';

export const metadata: Metadata = {
    title: 'Contact X-Clash',
    description: 'Get in touch with the X-Clash team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact X-Clash', 'X-Clash support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
