...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies X-Clash uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['X-Clash cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how X-Clash uses them, and how you can
                ...
                <p>X-Clash uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on X-Clash.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@x-clash.online</strong>.
                </p>
            </div>
        </>
    );
