...
export const metadata: Metadata = {
    ...
    description: 'X-Clash is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['X-Clash accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making X-Clash accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    X-Clash is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of X-Clash presents additional accessibility
                    challenges due to its visual and interactive nature. We are working on the following
                    improvements:
                </p>
                <ul>
                    <li>High-contrast mode for the game interface</li>
                    <li>Keyboard-only controls</li>
                ...
                <ul>
                    <li>The game requires visual perception and interaction, which may present challenges for users with certain visual or cognitive disabilities.</li>
                    <li>Drag-and-drop or similar interactive controls may be difficult for some users with motor impairments. We are exploring alternative interaction patterns.</li>
                    <li>Some third-party content (such as advertisements) may not meet our accessibility standards.</li>
                </ul>

                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of X-Clash. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@x-clash.online</strong></li>
                </ul>
                <p>
