...
export const metadata: Metadata = {
  ...
  description:
    'Browse all X-Clash puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'X-Clash categories'],
  alternates: {
