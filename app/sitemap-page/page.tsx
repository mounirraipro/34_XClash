...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of X-Clash. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['X-Clash sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is X-Clash?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on X-Clash.</p>
                </div>
            </div>
