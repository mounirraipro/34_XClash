...
const SITE_URL = 'https://x-clash.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'X-Clash',
        url: SITE_URL,
        description: 'Play X-Clash free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play X-Clash online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
