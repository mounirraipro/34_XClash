...
export const metadata: Metadata = {
    ...
    description: 'Read the X-Clash Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['X-Clash privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At X-Clash, we are committed to protecting your privacy and ensuring transparency
                ...
                <p>
                    ...
                    For detailed information about the cookies we use and your choices regarding cookies,
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of X-Clash, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    X-Clash is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@x-clash.online</strong>.
                </p>
            </div>
        </>
    );
